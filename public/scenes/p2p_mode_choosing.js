export default class P2PModeChoosing extends Phaser.Scene {
  ...
  create() {
    ...
    this.tenToWin = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.tenToWin.setScale(0.105);
        this.tenToWin_text.setScale(1.05);
        setTimeout(() => {
          this.tenToWin.setScale(0.1);
    ...
    this.twentyToWin = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.twentyToWin.setScale(0.105);
        this.twentyToWin_text.setScale(1.05);
        setTimeout(() => {
          this.twentyToWin.setScale(0.1);
    ...
    this.joinRoom = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.joinRoom.setScale(0.125, 0.105);
        this.joinRoom_text.setScale(1.05);
        setTimeout(() => {
          this.joinRoom.setScale(0.12, 0.1);
